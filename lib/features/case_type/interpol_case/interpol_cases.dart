...
class InterpolCases extends StatefulWidget {
  final String fId;
  InterpolCases({this.fId});
  @override
  _InterpolCasesState createState() => _InterpolCasesState();
}

class _InterpolCasesState extends State<InterpolCases> {
  ...
  void initState() {
    ...
    _interpole=_firmInterpolCaseRepo.getInterpolCases(widget.fId);
          ...
          child: Padding(
            ...
            child: ListTile(
              ...
              onTap: () {
                ...
                Navigator.of(context).pushNamed('/interPoleCasesDetail',arguments: caseId);
