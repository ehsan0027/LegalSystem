...
class Judgement extends StatefulWidget {
 final String firmId;
  Judgement({this.firmId});
  @override
  _JudgementState createState() => _JudgementState();
}
...
class _JudgementState extends State<Judgement> {
  ...
  void initState() {
    ...
    if (GV.case_type == "civil") {
      ...
      _judgement = _firmCivilCaseRepo.getJudgementCases(widget.firmId);
    }
    else if(GV.case_type == "criminal"){
      _firmCriminalCaseRepo=FirmCriminalCaseRepoImpl();
      _judgement=_firmCriminalCaseRepo.getJudgementCases(widget.firmId);
    }
  }
  @override
