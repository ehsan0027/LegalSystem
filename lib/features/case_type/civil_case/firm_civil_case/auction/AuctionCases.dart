...
class AuctionCases extends StatefulWidget {
  final String firmId;
  AuctionCases({this.firmId});
  @override
  _AuctionCasesState createState() => _AuctionCasesState();
}

class _AuctionCasesState extends State<AuctionCases> {
  ...
  void initState() {
    ...
    if (GV.case_type == "civil") {
      ...
      _auction = _firmCivilCaseRepo.getAuctionCases(widget.firmId);
    }else if(GV.case_type == "criminal"){
      _firmCriminalCaseRepo = FirmCriminalCaseRepoImpl();
      _auction =
          _firmCriminalCaseRepo.getAuctionCases(widget.firmId);
    }
  }
  @override
