...
class _ExecutionState extends State<Execution> {
  ...
  void initState() {
    ...
    if (GV.case_type == "civil") {
      ...
      _execution = _firmCivilCaseRepo.getExecutionCases(widget.firmId);
    }else if(GV.case_type == "criminal"){
      _firmCriminalCaseRepo = FirmCriminalCaseRepoImpl();
      _execution = _firmCriminalCaseRepo.getExecutionCases(widget.firmId);
    }
  }
  @override
              ...
              onTap: () {
                ...
                if (GV.case_type == "civil") {
                  Navigator.of(context).pushNamed(
                      '/firmCivilCaseDetails', arguments: caseId);
                }else if(GV.case_type == "criminal"){
                  Navigator.of(context).pushNamed(
                      '/firmCriminalCaseDetails', arguments: caseId);
                }
              },
            ),
          ),
