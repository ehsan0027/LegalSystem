...
class CourtProcedding extends StatefulWidget {
  final String fId;
  ...
  @override
  _CourtProceddingState createState() => _CourtProceddingState();
}

class _CourtProceddingState extends State<CourtProcedding> {
  FirmCivilCaseRepo _firmCivilCaseRepo;
  FirmCriminalCaseRepo _firmCriminalCaseRepo;
  Future _courtProceeding;
  ...
  void initState() {
    if (GV.case_type == "civil") {
      ...
      _courtProceeding =
          _firmCivilCaseRepo.getCivilCourtProceedingCases(widget.fId);
    } else if(GV.case_type == "criminal"){
      _firmCriminalCaseRepo = FirmCriminalCaseRepoImpl();
      _courtProceeding =
          _firmCriminalCaseRepo.getCriminalCourtProceedingCases(widget.fId);
    }
  }
